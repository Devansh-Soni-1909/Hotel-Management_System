...
class Roombooking:
    def __init__(self,root):
        ...
        lbl_cust_contact.grid(row=0, column=0, sticky=W, padx=10)  # Added padx for better alignment

        entry_contact = ttk.Entry(labelframeleft,textvariable=self.var_contact, width=16, font=("arial", 12, "bold"))
        entry_contact.grid(row=0, column=1, padx=2,sticky=W)  # Adjusted padx for consistency
        ...
        # check-in date
        check_in_data = Label(labelframeleft, text="Check in Date:", font=("arial", 12, "bold"), padx=2, pady=6)
        check_in_data.grid(row=1, column=0, sticky=W)

        txtcheck_in_data = ttk.Entry(labelframeleft,textvariable=self.var_checkin, width=22, font=("arial", 12, "bold"))
        txtcheck_in_data.grid(row=1, column=1)

        # check-out date
        lbl_check_out = Label(labelframeleft, text="Checkout Date:", font=("arial", 12, "bold"), padx=2, pady=6)
        lbl_check_out.grid(row=2, column=0, sticky=W)

        txt_check_out = ttk.Entry(labelframeleft, textvariable=self.var_checkout,width=22, font=("arial", 12, "bold"))
        ...
        combo_RoomType = ttk.Combobox(labelframeleft, textvariable=self.var_roomtype,font=("arial", 12, "bold"), width=22, state="readonly")
        ...
        combo_RoomNo = ttk.Combobox(labelframeleft, textvariable=self.var_roomavailable,font=("arial", 12, "bold"), width=22, state="readonly")
        ...
        txtPaidTax = ttk.Entry(labelframeleft, textvariable=self.var_paidtax,width=22, font=("arial", 12, "bold"))
        ...
        txtSubTotal = ttk.Entry(labelframeleft,textvariable=self.var_actualtotal, width=22, font=("arial", 12, "bold"))
        ...
        #*********right side image**********
        img3 = Image.open(r"C:\Users\nandk\OneDrive\Desktop\Python\Hotel_Management_System\images\1633410403702hotel-images\hotel images\bed.jpg")
    ...
    def add_data(self):
        if self.var_contact.get()=="" or self.var_checkin.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Successs","Room Booked",parent = self.root)
